      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Sezónní pracovní nabídky z Norska přeložené do češtiny",
            inLanguage: "cs",
            potentialAction: {
              "@type": "SearchAction",
              target: "https://norsko-prace.cz/prace?q={search_term_string}",
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pb-20 pt-40 md:px-8 md:pb-24">
        ...
        <p className="mb-10 max-w-xl text-lg leading-relaxed text-white/70">
          Stovky sezónních nabídek přeložených do češtiny — aktualizováno každý den.
        </p>
        ...
        {items.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-[var(--color-border)] py-16 text-center">
            <p className="text-[var(--color-text-muted)]">
              ...
              <code className="rounded bg-[#fde8ec] px-1.5 py-0.5 text-xs text-[#C8102E]">/api/sync</code>.
            </p>
          </div>
        )}
...
function HowItWorks() {
  const steps = [
    {
      ...
      desc: "Procházej stovky sezónních nabídek z Norska přeložených do češtiny. Žádná norština potřeba.",
  ...
  return (
    <section id="jak-to-funguje" className="relative overflow-hidden py-24" style={{ background: "#0d1117" }}>
            ...
            {steps.map((step, i) => (
              <div key={step.num} className="relative flex gap-8 md:gap-10 pb-12 last:pb-0">
                ...
                <div className="flex-1 pt-1.5 pb-4">
                  ...
                  <p className="text-white/50 leading-relaxed mb-4 text-sm md:text-base">{step.desc}</p>
      ...
      <div className="relative mx-auto max-w-6xl px-4 md:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mb-8 text-lg text-white/80">
            D-number, BankID, zdanění — vše co potřebuješ před odjezdem. Přečti si naše bezplatné průvodce.
          </p>
          <Link
            href="/blog"
